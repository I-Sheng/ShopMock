...
GRANT USAGE ON SCHEMA commerce TO internal_backend;
GRANT SELECT, INSERT, UPDATE ON commerce.customers, commerce.accounts, commerce.addresses TO internal_backend;
GRANT USAGE, SELECT ON ALL SEQUENCES IN SCHEMA commerce TO internal_backend;
SQL
